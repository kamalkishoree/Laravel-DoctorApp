            ...
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    ...
                    <div class="card-body" id="bar-parent">
                        <form action="{{route('speciality-update',$data['id'])}}" method="post" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="specialist" value="{{$data['specialist']}}" data-required="1" placeholder="enter speciality" class="form-control input-height" /> </div><br>
                                        @error('specialist')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="compose-editor">
                                        ...
                                        <img src="{{asset('/specialistImage/'.$data['image'])}}" width="150px" height="160"/>
                                    </div>
                                </div>
